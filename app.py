        ...
        if sym:
            with url_placeholder.container():
                st.markdown(
                    ...
                    f"[TVC (🔗)](https://www.tradingview.com/chart/?symbol=NSE%3A{sym}) &nbsp;|&nbsp; "
                    f"[CL (🔗)](https://chartink.com/stocks-new?symbol={sym}) &nbsp;|&nbsp; "
                    f"[CL2 (🔗)](https://chartink.com/stocks-new?load-snapshot=exponential-moving-average-simple-moving-average-simple-moving-average-moving-average-convergence-divergence-chart-snapshot-175&symbol={sym}) &nbsp;|&nbsp; "
                    f"[History (🔗)](https://www.equitypandit.com/historical-data/{sym}) &nbsp;|&nbsp; "
                    f"[Screener (🔗)](https://www.screener.in/company/{sym}) &nbsp;|&nbsp; "
                    f"[Zerodha (🔗)](https://www.zerodha.com/markets/stocks/NSE/{sym}) &nbsp;|&nbsp; "
